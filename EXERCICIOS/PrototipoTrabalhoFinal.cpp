...
int main(){
    ...
    cena.push_back(&peBanco2);

    Malha peBanco3(22, vertices, faces);
    ...
    cena.push_back(&peBanco3);

    Malha peBanco4(23, vertices, faces);
