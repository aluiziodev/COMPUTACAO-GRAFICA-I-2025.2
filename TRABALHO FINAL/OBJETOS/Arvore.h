...
struct Arvore : ObjetoMulti{
    ...
    Arvore(string nome){
        ...
        Cilindro *tronco = new Cilindro(aux, 0.3, 4.0, Pt(14, 0.01, 23.0), Vt(0, 1, 0.0));
        ...
        Esfera *folhasInf = new Esfera(nome, 5, Pt(14, 8.5, 23.0));
        ...
        Esfera *folhasSup = new Esfera(nome, 4, Pt(13.8, 13.5, 23.0));
