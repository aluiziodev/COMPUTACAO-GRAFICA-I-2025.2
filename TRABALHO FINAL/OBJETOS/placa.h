...
struct Placa : ObjetoMulti{
    Placa(int id){
        ...
        Malha *placac = new Malha(30, vertices, faces);
        ...
        Malha *placab = new Malha(31, vertices, faces);
        placab->kdif = RGB(0.545, 0.271, 0.075);
        placab->kesp = RGB(0.545, 0.271, 0.075);
        placab->kamb = RGB(0.545, 0.271, 0.075);
        placab->m = 3;
        Matriz t = Transformacoes::rotacaoY(180) * Transformacoes::transladar(-35, -3, -12) ;
        ...
        //PES DO BANCO
        Malha *placaA = new Malha(32, vertices2, faces2);
